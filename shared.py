...
def doPersonaInformation1(driver):
    element = driver.find_element_by_xpath("//div[@class='wrapit']/h4[2]/a")
    element.click()
    element = driver.find_element_by_xpath("//div[@id='div_id_personal_info-first_name']/input")
    element.clear()
    element.send_keys("Andrew")
...
def doPayment_form(driver):
    element = driver.find_element_by_xpath("//div[@class='form_block']/a[@class='btn btn-primary']/span")
    element.click()
    element = driver.find_element_by_xpath("//input[@id='id_first_name']")
    element.clear()
    element.send_keys("Andrew")
    element = driver.find_element_by_xpath("//input[@id='id_last_name']")
    element.clear()
    element.send_keys("Trofimchuk")
    element = driver.find_element_by_xpath("//input[@id='id_address']")
    element.clear()
    element.send_keys("Golosiivska St.")
    element = driver.find_element_by_xpath("//input[@id='id_city']")
    element.clear()
    element.send_keys("Sacramento")
    element = driver.find_element_by_id('id_state')
    select = Select(element)
    select.select_by_visible_text("California")
    element = driver.find_element_by_xpath("//input[@id='id_zip']")
    element.clear()
    element.send_keys("11111")
    element = driver.find_element_by_xpath("//input[@id='id_card_num']")
    element.clear()
    element.send_keys("370000000000002")
    element = driver.find_element_by_id('id_exp_date_0')
    select = Select(element)
    select.select_by_visible_text("02")
    element = driver.find_element_by_id('id_exp_date_1')
    select = Select(element)
    select.select_by_visible_text("2016")
    element = driver.find_element_by_xpath("//input[@id='id_card_code']")
    element.clear()
    element.send_keys("999")

def doCadc2(driver):
    element = driver.find_element_by_xpath("//div[@class='row menu']/div[@class='col-sm-3'][2]/ul[3]/li[6]/a")
    element.click()

def doLAADC(driver):
    element = driver.find_element_by_xpath("//div[@class='row menu']/div[@class='col-sm-3'][2]/ul[3]/li[8]/a")
    element.click()

def doCCS(driver):
    element = driver.find_element_by_xpath("//div[@class='row menu']/div[@class='col-sm-3'][2]/ul[3]/li[9]/a")
    element.click()

def doCCJP(driver):
    element = driver.find_element_by_xpath("//div[@class='row menu']/div[@class='col-sm-3'][2]/ul[3]/li[11]/a")
    element.click()

def doCCPS(driver):
    element = driver.find_element_by_xpath("//div[@class='row menu']/div[@class='col-sm-3'][2]/ul[3]/li[12]/a")
    element.click()
...
def doForm3(driver):
    ...
    element = driver.find_element_by_id('id_academic_content_area')
    select = Select(element)
    select.select_by_visible_text("Counselor Development")
    element = driver.find_element_by_xpath("//div[@id='div_id_hours']/input")
    element.clear()
    element.send_keys('45')
    element = driver.find_element_by_id('id_grade')
...
def doForm4(driver):
    ...
    element = driver.find_element_by_id('id_academic_content_area')
    select = Select(element)
    select.select_by_visible_text("Dynamics of Addiction and Criminal Behavior")
    element = driver.find_element_by_xpath("//div[@id='div_id_hours']/input")
    element.clear()
    element.send_keys('45')
    element = driver.find_element_by_id('id_grade')
...
def doForm5(driver):
    ...
    element = driver.find_element_by_id('id_academic_content_area')
    select = Select(element)
    select.select_by_visible_text("Planning & Evaluation")
    element = driver.find_element_by_xpath("//div[@id='div_id_hours']/input")
    element.clear()
    element.send_keys('45')
    element = driver.find_element_by_id('id_grade')
